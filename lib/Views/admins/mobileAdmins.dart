...
class AdminsMobileLayout extends StatefulWidget {
  const AdminsMobileLayout(BuildContext context, {super.key});

  @override
  State<AdminsMobileLayout> createState() => _AdminsMobileLayoutState();
}

class _AdminsMobileLayoutState extends State<AdminsMobileLayout> {
                                                                  ...
                                                                  return AlertDialog(
                                                                    ...
                                                                    content: SizedBox(
                                                                        ...
                                                                        child: AddAdminScreen(
                                                                          isUpdate:
                                                                              true,
                                                                          userName: userInfoModel!
                                                                              .data
                                                                              .username,
                                                                          name: userInfoModel!
                                                                              .data
                                                                              .name,
                                                                          password: userInfoModel!
                                                                              .data
                                                                              .password,
                                                                          id: userInfoModel!
                                                                              .data
                                                                              .id,
                                                                          permissions: userInfoModel!
                                                                              .data
                                                                              .permissions,
                                                                        )),
                                                                  );
